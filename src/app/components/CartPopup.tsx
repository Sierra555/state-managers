...
export default function CartPopup({
  ...
  // const [cart, setCart] = useCart(); //context api
  // const cart = useCart(); //redux
  // const dispatch = useDispatch(); //redux
  // const { cart, setCart } = useCart()(); //zustand
      ...
      <div className="flex flex-col items-center justify-center w-1/2 p-4 bg-white rounded-lg">
        ...
        <div className="flex justify-between w-full">
          <button
            ...
            // onClick={async () => setCart(await clearCartAction())} //context api
            // onClick={async () => dispatch(setCart(await clearCartAction()))} // redux
