...
import InitReviewsWrapper from "./components/InitReviewsWrapper";

import { getProductById, getProducts } from "@/api/products";
import { addToCart } from "@/api/cart";
import { addReview } from "@/api/products";

// import { ReviewsProvider } from "@/app/context/ReviewsProviderForZustand";
// import { ReviewsContextProvider } from "@/app/context/ReviewsContext";
...
export default async function ProductDetail({
  ...
  return (
    // <ReviewsContextProvider reviews={product.reviews}> //context api
    // <ReviewsProvider reviews={product.reviews}> //zustand
    // <InitReviewsWrapper reviews={product.reviews}> //redux
